...
function binaryToHexadecimal(blob) {
  // Your code here
    // Remove the '0b' prefix and convert binary to decimal, then to hexadecimal
...
function hexadecimalToAscii(blob) {
  // Your code here
  return String.fromCharCode(parseInt(blob.slice(2), 16));
}

/* ASCII to base 10 */
function asciiToDecimal(blob) {
  // Your code here
  return blob.split('').map(char => char.charCodeAt(0));
}
